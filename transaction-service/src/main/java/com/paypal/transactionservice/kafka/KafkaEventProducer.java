...
public class KafkaEventProducer {
    ...
    public void sendTransactionEvent(String key, Transaction transaction ){
        ...
        future.thenAccept(result -> {
            ...
            System.out.println("Kafka message sent successfullt ! Topic : " + metadata.topic() + ", Partition: " + metadata.partition() + ", Offset: " + metadata.offset());
        }).exceptionally(ex -> {
            System.err.println("Kafka message sent failed !");
            ex.printStackTrace();
            return null;
        });
    }
